      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <Link
              href="/admin/products"
              className="rounded-lg border border-gray-300 bg-white px-5 py-3 text-sm font-medium transition hover:bg-gray-100"
            >
              Manage Products
            </Link>
          </div>
        ...
        <div className="mt-8 rounded-xl border bg-white p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            ...
            <Link
              ...
              className="rounded-lg border px-5 py-3 text-sm font-medium transition hover:bg-gray-100"
            >
              Add Product
            </Link>
            <Link
